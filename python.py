...
https://www.youtube.com/watch?v=aBexJgZ6GjI&ab_channel=ProgrammingKnowledge

https://rhettinger.wordpress.com/2011/05/26/super-considered-super/

83) Similarly, we can overload other operators as well. The special function that we need to implement is tabulated below.
